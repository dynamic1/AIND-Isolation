...
class IsolationSquare:
    """A Isolation Game square class."""
    ...
    def draw(self):
        ...
        AAfilledRoundedRect(screen, (self.offsetX, self.offsetY, 90, 90), self.color)
    ...
    def make_used(self):
        self.text = self.font.render("x", 1, (0, 0, 0))
        self.draw()
        return 0
    ...
    def make_A(self):
        self.text = self.font.render("A", 1, (0, 255, 0))
        self.draw()
        return 0

    def make_B(self):
        self.text = self.font.render("B", 1, (0, 0, 255))
        self.draw()
        return 0
